function $Showhtml(){
	...
	player +='<embed src="'+ff_root+'Public/player/flv.swf" allowFullScreen="true" FlashVars="vcastr_file='+Player.Url+'&vcastr_title=www.ppvod.net&IsAutoPlay=1" menu="false" quality="high" width="100%" height="'+Player.Height+'" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" /></object>';	
	return player;
}
Player.Show();
