function $Showhtml(){
	...
	player += '<param name="EmbedURL" value="http://www.ppvod.net/?web9">';
	player += '<param name="URL" value="'+url+'">';
	player += '<param name="TextAds" value="飞飞影视导航系统ASP版|http://www.ppvod.net/@飞飞影视导航系统PHP版|http://www.ppvod.net">';
